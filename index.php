...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="efecto_aparecer">
                <div><img width="100%" src="img/portada_index.jpg" alt=""></div>
            </section>
            ...
            <section class="content container-fluid">
               ...
               <div class="centrado <?php if ($total_productos <= $productos_pagina) { echo "ocultar"; } else { echo "efecto_aparecer3"; } ?>">
                    <nav aria-label="Page navigation">
                        ...
                        <div>
                            <form action="javascript:index_ir_a_pagina(<?php echo $total_paginas ?>)">
                                <label for="pagina">Página </label>
                                <input id="pagina" name="pagina" value="<?php echo $pagina ?>" type="text" autocomplete="off">
                                <label>de <?php echo $total_paginas ?></label>
                                <button id="pagina_boton" type="button" onclick="index_ir_a_pagina(<?php echo $total_paginas ?>)">Ir</button>
                            </form>
                        </div>
                    </nav>
                </div>
