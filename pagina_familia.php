            ...
            <section class="content container-fluid">
                   ...
                   <div class="centrado <?php if ($total_productos <= $productos_pagina) { echo "ocultar"; } else { echo "efecto_aparecer3"; } ?>">
                    <nav aria-label="Page navigation">
                        ...
                        <div>
                            <form action="javascript:familia_ir_a_pagina(<?php echo $total_paginas . ", " . $familia_id ?>)">
                                <label for="pagina">Pagina </label>
                                <input id="pagina" name="pagina" value="<?php echo $pagina ?>" type="text" autocomplete="off">
                                <label>de <?php echo $total_paginas ?></label>
                                <button id="pagina_boton" type="button" onclick="familia_ir_a_pagina(<?php echo $total_paginas . ", " . $familia_id ?>)">Ir</button>
                            </form>
                        </div>
                    </nav>
                </div>
