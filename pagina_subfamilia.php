    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <div class="row efecto_aparecer3">
                        ...
                        <div class="col-md-4">
                            <a title="Generar PDF de todos los productos de esta categoría" class="btn btn-default btn-lg pull-right" href="crear_pdf_subfamilia.php?id=<?php echo $subfamilia[0]["id"]; ?>" target="_blank"><i class="far fa-file-pdf"></i></a>
                        </div>
                    </div>
                </h1>
                <!--
            ...
            <section class="content container-fluid">
                   ...
                   <div class="centrado <?php if ($total_productos <= $productos_pagina) { echo "ocultar"; } else { echo "efecto_aparecer3"; } ?>">
                    <nav aria-label="Page navigation">
                        ...
                        <div>
                            <form action="javascript:subfamilia_ir_a_pagina(<?php echo $total_paginas . ", " . $subfamilia_id ?>)">
                                <label for="pagina">Pagina </label>
                                <input id="pagina" name="pagina" value="<?php echo $pagina ?>" type="text" autocomplete="off">
                                <label>de <?php echo $total_paginas ?></label>
                                <button id="pagina_boton" type="button" onclick="subfamilia_ir_a_pagina(<?php echo $total_paginas . ", " . $subfamilia_id ?>)">Ir</button>
                            </form>
                        </div>
                    </nav>
                </div>
