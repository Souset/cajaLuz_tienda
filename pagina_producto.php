...
<!-- INICIO CONTENEDOR DEL CONTENIDO -->
    ...
    <!--  INICIO FAMILIA Y SUBFAMILIA (MIGA DE PAN) -->
            <section class="content-header">
                <h1>
            <!-- INICIO MIGA DE PAN -->
                    <div class="row efecto_aparecer3">
                        <div class="col-md-8">
                ...
                <!-- INICIO BOTONES GENERAR PDF Y DEMÁS -->
                        <div class="col-md-4">
                            <a title="Generar PDF de este producto" class="btn btn-default btn-lg pull-right" href="crear_pdf.php?id=<?php echo $producto[0]["id"]; ?>" target="_blank"><i class="far fa-file-pdf"></i></a>
                            <?php if ($producto[0]["imagenInstalacion"] != "") { ?>
                            <a title="Instalación" class="btn btn-default btn-lg pull-right" href="<?php echo $producto[0]["imagenInstalacion"]; ?>" target="_blank"><i class="fas fa-user-cog"></i></a>
                            <?php } ?>
                            <?php if ($producto[0]["imagenLuminica"] != "") { ?>
                            <a title="Imágen Lumínica" class="btn btn-default btn-lg pull-right" href="<?php echo $producto[0]["imagenLuminica"]; ?>" target="_blank"><i class="far fa-sun"></i></a>
                            <?php } ?>
                            <?php if ($producto[0]["imagenEsquema"] != "") { ?>
                            <a title="Esquema" class="btn btn-default btn-lg pull-right" href="<?php echo $producto[0]["imagenEsquema"]; ?>" target="_blank"><i class="fas fa-image"></i></a>
                            <?php } ?>
                        </div>
                <!-- FIN BOTONES GENERAR PDF Y DEMÁS -->
                    </div>
                </h1>
        <!-- INICIO MIGA DE PAN ALTERNATIVA
                <div class="row">
                    <div class="col-md-9">
                        <h4>
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <small><a href="pagina_subfamilia.php?subfamilia=<?php echo $familia_subfamilia[0]["subfamilia_id"] ?>">
                                        <?php echo $familia_subfamilia[0]["subfamilia"] ?>
                                    </a></small>
                                </li>

                                <li class="active">
                                    <small><small>
                                        <?php echo $producto[0]["titulo"] ?>
                                    </small></small>
                                </li>
                            </ol>
                        </h4>
    ...
    <!-- INICIO CONTENIDO PRINCIPAL -->
                ...
                <!-- FIN TÍTULO Y PRECIO -->
                    ...
                    <!-- INICIO SELECCIÓN DE CANTIDAD -->
                            <div class="row margen_interno_20 sin_padding mas_menos margen_bajo_0">
                                <form action="javascript:calcular(<?php echo $producto[0]["PVP"] . ", " . $producto[0]["stock"]; ?>)">
                                    ...
                                    <div class="col-xs-2">
                                        <input name="cantidad" id="cantidad" class="form-control" type="text" value="<?php if ($producto[0]["stock"] == 0) { echo "0"; } else { echo "1"; } ?>" min="<?php if ($producto[0]["stock"] == 0) { echo "0"; } else { echo "1"; } ?>" max="<?php echo $producto[0]["stock"]; ?>" onblur="calcular(<?php echo $producto[0]["PVP"] . ", " . $producto[0]["stock"]; ?>)">
                                    </div>
                                    <div class="col-xs-1">
                            ...
                            <div>
                                <button <?php if ($producto[0]["stock"] == 0) { ?> disabled = "true" <?php } ?> type="button" class="btn btn-lg btn-block btn-primary" onclick="añadir_al_carrito(<?php echo $id ?>)" data-toggle="modal" data-target="#producto_anyadido">Añadir al carrito</button>
                            </div>
        ...
        <!-- INICIO ZONA INFERIOR -->
                <div class="row efecto_aparecer2">
  ...
  experiencia de usuario. -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var stock = <?php echo $producto[0]["stock"]; ?>;
